classdef BehaviorBoxWheel < handle
    ...
    methods
        ...
        function opts = buildMappingOptions_(this, style)
            ...
            opts.FlashY = this.sliderToMapCoord_(this.getAppNumericValue_("Animate_YPosition", 0.5));
        ...
        function [rows, fixState, aborted] = runMappingFlashContour_(this, rows, t0, modeName, targets, opts, fixState)
            ...
            for idx = 1:numel(xPositions)
                ...
                xPos = xPositions(idx);
                targets.MapGroup.Matrix = this.makeMappingTransform_(xPos, opts.FlashY, opts.OrientedLineAngleDeg, 1);
                targets.MapRandomLine.Visible = 'off';
                targets.MapContourLine.Visible = 'on';
                [rows, ~] = this.appendMappingEvent_(rows, t0, modeName, "FlashOn", ...
                    struct('x', xPos, 'y', opts.FlashY, 'angleDeg', opts.OrientedLineAngleDeg, ...
