classdef BehaviorBoxVisualStimulus < handle
    ...
    methods % methods, including the constructor are defined in this block
        ...
        function finishLine_(this)
            % Two triangles in the middle; static (not pooled since it's created once).
            if isempty(this.fig) || ~isgraphics(this.fig)
                return
            end
            this.FLAx = axes('Parent', this.fig, ...
                'Color', 'none', ...
            ...
            % Simple filled triangles (match your original geometry)
            y = 0.5; w = 0.02; h = 0.08;
            % left-pointing triangle
            patch('Parent', this.FLAx, ...
                'XData', [-w 0 -w], ...
                'YData', [y-h y y+h], ...
...
% Make this visually similar to the stimulus elements
        ...
        function ensurePools_(this)
            ...
            if isempty(this.LDistractorLine) || ~isgraphics(this.LDistractorLine)
                this.LDistractorLine = line(this.LStimGroup, nan, nan, ...
            ...
            if isempty(this.LContourLine) || ~isgraphics(this.LContourLine)
                this.LContourLine = line(this.LStimGroup, nan, nan, ...
                    'Color', this.LineColor, 'LineWidth', this.SegThick, ...
                    'Tag', 'Contour', ...
                    'PickableParts', 'none', 'HitTest', 'off', ...
                    'Clipping', 'off');
            ...
            if isempty(this.RDistractorLine) || ~isgraphics(this.RDistractorLine)
                this.RDistractorLine = line(this.RStimGroup, nan, nan, ...
                    'Color', this.LineColor, 'LineWidth', this.SegThick, ...
                    'Tag', 'Distractor', ...
                    'PickableParts', 'none', 'HitTest', 'off', ...
                    'Clipping', 'off');
            ...
            if isempty(this.RContourLine) || ~isgraphics(this.RContourLine)
                this.RContourLine = line(this.RStimGroup, nan, nan, ...
                    'Color', this.LineColor, 'LineWidth', this.SegThick, ...
                    'Tag', 'Contour', ...
                    'PickableParts', 'none', 'HitTest', 'off', ...
                    'Clipping', 'off');
