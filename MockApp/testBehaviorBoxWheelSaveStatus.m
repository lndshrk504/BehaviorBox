...
assert(isequal(size(loaded.newData.EyeTrackingRecord.points_xyp{1}), [8 3]), 'Saved eye-point matrix shape is wrong.');
...
assert(all(ismember(["eye_x", "eye_y", "eye_diameter_px", "eye_isValid"], frameVars)), ...
