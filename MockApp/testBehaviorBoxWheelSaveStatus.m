...
wheelAnim.EyeTrack.processReading(makeEyeJson_(posixtime(wheelAnim.TrainStartWallClock) + 100e-6), 0);
...
function jsonText = makeEyeJson_(captureTimeUnixS)
if nargin < 1
    captureTimeUnixS = 1736891234.123400;
end
